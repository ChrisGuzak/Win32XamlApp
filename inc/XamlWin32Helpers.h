...
inline PCWSTR MakeIntResourceId(int i)
{
    return reinterpret_cast<PCWSTR>(static_cast<ULONG_PTR>(i));
}
...
winrt::Windows::UI::Xaml::UIElement LoadXamlResource(HMODULE mod, uint32_t id, PCWSTR type = MakeIntResourceId(XAMLRESOURCE))
{
...
template <typename T>
void RegisterWindowClass(PCWSTR windowClassName)
{
